  ...
  <div class="pages">
    ...
    <a-table :columns="columns" :data-source="data" style="margin-top: 20px;">
      ...
      <span
        ...
        class="btns"
      >
        <a-button type="danger" @click="deleteOld(id.id)">删除</a-button>
      ...
      <div>
        <a-form :layout="formLayoutAdd">
          <a-form-item
            ...
            :wrapper-col="formItemLayout.wrapperCol"
          >
            <a-input placeholder="请输入老人姓名" v-model="newOld.name"/>
          </a-form-item>
          <a-form-item
            label="房间号"
            :label-col="formItemLayout.labelCol"
            :wrapper-col="formItemLayout.wrapperCol"
          >
            <a-input placeholder="请输入老人房间号" v-model="newOld.room"/>
          </a-form-item>
          <a-form-item
            label="手机号"
            :label-col="formItemLayout.labelCol"
            :wrapper-col="formItemLayout.wrapperCol"
          >
            <a-input placeholder="请输入手机号" v-model="newOld.phone"/>
          </a-form-item>
          <a-form-item
            label="身份ID"
            :label-col="formItemLayout.labelCol"
            :wrapper-col="formItemLayout.wrapperCol"
          >
            <a-input placeholder="请输入身份ID" v-model="newOld.id_card"/>
          </a-form-item>
          <a-form-item
            label="年龄"
            :label-col="formItemLayout.labelCol"
            :wrapper-col="formItemLayout.wrapperCol"
          >
            <a-input placeholder="请输入老人年龄" v-model="newOld.age"/>
          </a-form-item>
          <a-form-item
            label="性别"
            :label-col="formItemLayout.labelCol"
            :wrapper-col="formItemLayout.wrapperCol"
          >
            <a-radio-group name="radioGroup" v-model="newOld.gender">
              <a-radio :value="1">
                男
              </a-radio>
              <a-radio :value="2">
...
export default {
  ...
  methods: {
    ...
    updateInfo(id){
      ...
      this.$router.push({path:'/list/query/update/'+id.id,query:{id:id}});
    },
    viewInfo(id) {
        console.log(id)
      this.$router.push({path:'/list/query/detail/'+id.id,query:{id:id.id}});
    },
    handleChange(info) {
